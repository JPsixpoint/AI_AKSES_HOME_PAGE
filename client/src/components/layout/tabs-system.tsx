              ...
              <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    {/* AI Agents as Parent Category */}
                    <div className="mb-4">
                      <button
                        className="w-full text-left px-3 py-3 rounded-md hover:bg-dark-surface flex items-center border border-transparent hover:border-dark"
                        onClick={() => {
                          ...
                          addNewTab("AI Agents Orchestration", "AI Agents");
                        }}
                      >
                        ...
                        <div>
                          <div className="font-medium text-sm">AI Agents</div>
                          <div className="text-xs text-muted-foreground">Create and manage intelligent AI agents for specific tasks</div>
                        </div>
                      </button>
                      ...
                      <div className="pl-10 mt-2 space-y-2">
                        ...
                        <button
                          className="w-full text-left px-3 py-2 rounded-md hover:bg-dark-surface flex items-center border border-transparent hover:border-dark"
                          onClick={() => {
                            const existingTab = tabs.find(tab => tab.type === "Rag Databases");
                            if (existingTab) {
                              setActiveTabId(existingTab.id);
                              setIsNewTabDialogOpen(false);
                              return;
                            }
                            addNewTab("Rag Databases", "RAG Vault");
                          }}
                        >
                          <div className="mr-3 text-primary">
                    ...
                    <div className="space-y-1">
                      <button
                        className="w-full text-left px-3 py-3 rounded-md hover:bg-dark-surface flex items-center border border-blue-800 bg-blue-950/30"
                        onClick={() => {
                          const existingTab = tabs.find(tab => tab.type === "AKSES Architecture");
                          if (existingTab) {
                            setActiveTabId(existingTab.id);
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="text-xs text-muted-foreground">Three-Tiered AI Orchestration Architecture and system components</div>
                        </div>
                      </button>
                    </div>
                  </div>
