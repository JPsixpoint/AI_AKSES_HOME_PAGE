          ...
          <div className="relative mb-3">
            <div className="flex items-center relative">
              <textarea
                ...
                className="flex-1 bg-dark-lighter rounded-md border border-gray-700 pl-3 pr-9 py-3 text-sm focus:outline-none focus:ring-1 focus:ring-primary-light h-10 resize-none command-input"
              />
              <button 
                type="button"
